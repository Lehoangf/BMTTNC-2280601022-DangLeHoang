...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font = QtGui.QFont()
        font.setFamily("SVN-Gilroy SemiBold")
        ...
        self.label_4.setGeometry(QtCore.QRect(440, 100, 121, 31))
        font = QtGui.QFont()
        font.setFamily("SVN-Gilroy SemiBold")
        font.setPointSize(15)
        ...
        self.label_5.setGeometry(QtCore.QRect(440, 250, 121, 31))
        font = QtGui.QFont()
        font.setFamily("SVN-Gilroy SemiBold")
        font.setPointSize(15)
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(20, 350, 151, 31))
        font = QtGui.QFont()
        font.setFamily("SVN-Gilroy SemiBold")
        self.btn_encrypt.setFont(font)
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(200, 350, 151, 31))
        font = QtGui.QFont()
        font.setFamily("SVN-Gilroy SemiBold")
        self.btn_decrypt.setFont(font)
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(380, 350, 151, 31))
        font = QtGui.QFont()
        font.setFamily("SVN-Gilroy SemiBold")
        self.btn_sign.setFont(font)
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(560, 350, 151, 31))
        font = QtGui.QFont()
        font.setFamily("SVN-Gilroy SemiBold")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_gen_key.setText(_translate("MainWindow", "Generate"))
